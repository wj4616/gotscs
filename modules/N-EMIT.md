...
4. **Write files using the section-to-source assembly table:**
   ...
   | `<skill>/briefing-appendix-topology.md` | GOTSCS briefing (P0-5) | `cp ~/.claude/skills/gotscs/briefing-appendix-topology.md <skill>/` |
   | `<skill>/briefing-appendix-contract.md` | GOTSCS briefing (P0-5) | `cp ~/.claude/skills/gotscs/briefing-appendix-contract.md <skill>/` |
   | `<skill>/briefing-appendix-memory.md` | GOTSCS briefing (P0-5) | `cp ~/.claude/skills/gotscs/briefing-appendix-memory.md <skill>/` |
   | `<skill>/briefing-appendix-antipatterns.md` | GOTSCS briefing (P0-5) | `cp ~/.claude/skills/gotscs/briefing-appendix-antipatterns.md <skill>/` |
   | `<skill>/briefing-appendix-vocab.md` | GOTSCS briefing (P0-5) | `cp ~/.claude/skills/gotscs/briefing-appendix-vocab.md <skill>/` |
   ...
   **hats.json format guard:** When extracting `hats_json_content` from `stages/N-JSON.md`, verify the top-level value is a JSON array (`[...]`). If it is dict-keyed (`{"hats": {...}}` — legacy GOTSCS format leaking through), extract the dict values as an array before writing. The produced skill's `hats.json` MUST be array format per N-JSON step 1.5(e); a dict-format file will fail the G-13/2 schema check.
